...
1. implement this as a proper PTransform - add withCountAndHash parameters
2. make sure to do a git mv so history is preserved (and remove it from hifio)
3. also - maybe move into main repo, not just here?
